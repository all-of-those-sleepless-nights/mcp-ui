...
export declare class ProsController {
    private readonly prosService;
    constructor(prosService: ProsService);
    ...
    createTimeWindow(proId: number, dto: CreateProTimeWindowDto): Promise<{
        proId: number;
        start: string;
        end: string;
        id: number;
    ...
    createBadge(proId: number, dto: CreateProBadgeDto): Promise<{
        proId: number;
        id: number;
        label: string;
    }>;
    ...
    createExtra(proId: number, dto: CreateProExtraDto): Promise<{
        proId: number;
        id: number;
        name: string;
        price: number;
